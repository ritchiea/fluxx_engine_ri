...
properties.type=$elem.attr('method');$elem.fluxxCardLoadContent(properties)}]}}}});$.fluxx.stage.ui.header=['<div id="header">','<div id="logo"><a href=".">FLUXX</a></div>','<ul class="actions">','</ul>','</div>'].join('');$.fluxx.stage.ui.cardTable=['<div id="card-table">','<ul id="hand">','</ul>','</div>'].join('');$.fluxx.stage.ui.footer=['<div id="footer">Footer</div>'].join('');$(window).resize(function(e){$.my.stage.resizeFluxxStage();});})(jQuery);